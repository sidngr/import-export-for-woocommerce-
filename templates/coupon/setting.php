...
?>
<div class="sn-wie-setting-page coupon">
    <div class="sn-wie-header">
        <h2><?php echo( __('Manage coupon import export settings', SN_WIE_SLUG) ); ?></h2>
    ...
    <div class="sn-wie-box-section">
        ...
        <div class="setting-box">
            <form id="form_setting" action="<?php echo(admin_url('admin-post.php')) ?>" method="post" class="sn-wie-form  setting-form coupon">
                <input type="hidden" id="action" name="action" value="sn_wie_update_coupon_setting" />
                <div class="input-group">
                    <label class="control-label"><?php echo( __('Import records per request', SN_WIE_SLUG) ); ?></label>
                    <input type="number" id="import_record_per_request" name="import_record_per_request" class="form-control" value="<?php echo( $options['coupon_import_record_per_request'] ) ?>" />
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="export_record_per_request" name="export_record_per_request" class="form-control" value="<?php echo( $options['coupon_export_record_per_request'] ) ?>" />
