...
?>
<div class="sn-wie-export-page user">
    <div class="sn-wie-header">
        <h2><?php echo( __('Export users to a CSV file', SN_WIE_SLUG) ); ?></h2>
        <p><?php echo( __('This section allows you to generate and download a CSV file containing a list of all users', SN_WIE_SLUG) ); ?></p>
    </div>
    <div class="sn-wie-box-section">
        <?php wc_get_template( 'navigation.php', $args, '', SN_WIE_TEMPLATE_PATH .'/user/' );?>
        <div class="export-box">
            <form action="<?php echo(admin_url('admin-ajax.php')) ?>" method="post" class="sn-wie-form  export-form user">
                <input type="hidden" id="action" name="action" value="sn_wie_create_user_csv_file" />
                ...
                <div class="input-group meta-row">
                    <label class="control-label"><?php echo( __('Export user meta?', SN_WIE_SLUG) ); ?></label>
                ...
                <div class="input-group">
                    <label class="control-label"><?php echo( __('Which user roles should be exported?', SN_WIE_SLUG) ); ?></label>
                    <select id="export_user_roles" name="export_user_roles[]" multiple="multiple" class="form-control custom-select" style="width:100%;">
                        <?php
                    ...
                    <div class="input-hint"><?php echo( __('If none selected all users will be exported', SN_WIE_SLUG) ); ?></div>
                </div>
                <div class="input-row">
            ...
            <div class="export-modal" style="display:none;">
                <div class="export-dialog">
                    <div class="progress-bar-section">
                        ...
                        <div class="import-msg"><?php echo( __('Exporting users, please do not close or refresh the browser!', SN_WIE_SLUG) ); ?></div>
                    </div>
                    <div class="export-status-section" style="display:none">
                        <div class="status-box">
                            ...
                            <div class="stat export-count"><div class="caption"><?php echo( __('Users Exported', SN_WIE_SLUG) ); ?>: </div><div class="value">0</div></div>
