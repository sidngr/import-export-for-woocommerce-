...
?>
<div class="sn-wie-export-page order">
    <div class="sn-wie-header">
        <h2><?php echo( __('Export orders to a CSV file', SN_WIE_SLUG) ); ?></h2>
        <p><?php echo( __('This section allows you to generate and download a CSV file containing a list of all orders', SN_WIE_SLUG) ); ?></p>
    </div>
    <div class="sn-wie-box-section">
        <?php wc_get_template( 'navigation.php', $args, '', SN_WIE_TEMPLATE_PATH .'/order/' );?>
        <div class="export-box">
            <form action="<?php echo(admin_url('admin-ajax.php')) ?>" method="post" class="sn-wie-form  export-form order">
                <input type="hidden" id="action" name="action" value="sn_wie_create_order_csv_file" />
                ...
                <div class="input-group">
                    <label class="control-label"><?php echo( __('Which order statuses should be exported?', SN_WIE_SLUG) ); ?></label>
                    <select id="export_order_statuses" name="export_order_statuses[]" multiple="multiple" class="form-control custom-select" style="width:100%;">
                        <?php
                        foreach($order_status_list as $key => $order_status) {
                            ?>
                    ...
                    <div class="input-hint"><?php echo( __('If none selected all orders will be exported', SN_WIE_SLUG) ); ?></div>
                </div>
                <div class="input-row">
                ...
                <div class="export-dialog">
                    ...
                    <div class="export-status-section" style="display:none">
                        <div class="status-box">
                            ...
                            <div class="stat export-count"><div class="caption"><?php echo( __('Orders Exported', SN_WIE_SLUG) ); ?>: </div><div class="value">0</div></div>
