...
?>
<div class="sn-wie-export-page product">
    <div class="sn-wie-header">
        <h2><?php echo( __('Export products to a CSV file', SN_WIE_SLUG) ); ?></h2>
        <p><?php echo( __('This section allows you to generate and download a CSV file containing a list of all products', SN_WIE_SLUG) ); ?></p>
    </div>
    <div class="sn-wie-box-section">
        <?php wc_get_template( 'navigation.php', $args, '', SN_WIE_TEMPLATE_PATH .'/product/' );?>
        <div class="export-box">
            <form action="<?php echo(admin_url('admin-ajax.php')) ?>" method="post" class="sn-wie-form  export-form product">
                <input type="hidden" id="action" name="action" value="sn_wie_create_product_csv_file" />
                ...
                <div class="input-row">
                    <div class="input-group attribute-row left">
                        <label class="control-label"><?php echo( __('Export attributes?', SN_WIE_SLUG) ); ?></label>
                        <label class="switch"><input type="checkbox" id="export_attributes" name="export_attributes" class="form-control" value="1" checked="checked" /><span class="switch-slider"></span></label><?php echo( __('Yes, export all attributes', SN_WIE_SLUG) ); ?>
                    </div>
                    <div class="input-group meta-row right">
                ...
                <div class="input-group">
                    <label class="control-label"><?php echo( __('Which product types should be exported?', SN_WIE_SLUG) ); ?></label>
                    <select id="export_product_types" name="export_product_types[]" multiple="multiple" class="form-control custom-select" style="width:100%;">
                        <?php
                        foreach(['simple', 'grouped', 'external', 'variable', 'variation'] as $product_type) {
                            ?>
                    ...
                    <div class="input-hint"><?php echo( __('If none selected all product types will be exported', SN_WIE_SLUG) ); ?></div>
                </div>
                <div class="input-group">
                    <label class="control-label"><?php echo( __('Which product category should be exported?', SN_WIE_SLUG) ); ?></label>
                    <select id="export_categories" name="export_categories[]" multiple="multiple" class="form-control custom-select" style="width:100%;">
                        <?php
                    ...
                    <div class="input-hint"><?php echo( __('If none selected all products will be exported', SN_WIE_SLUG) ); ?></div>
                </div>
                <div class="input-row">
            ...
            <div class="export-modal" style="display:none;">
                <div class="export-dialog">
                    <div class="progress-bar-section">
                        ...
                        <div class="import-msg"><?php echo( __('Exporting products, please do not close or refresh the browser!', SN_WIE_SLUG) ); ?></div>
                    </div>
                    <div class="export-status-section" style="display:none">
                        <div class="status-box">
                            ...
                            <div class="stat export-count"><div class="caption"><?php echo( __('Products Exported', SN_WIE_SLUG) ); ?>: </div><div class="value">0</div></div>
                            <div class="stat file-name"><div class="caption"><?php echo( __('File Name', SN_WIE_SLUG) ); ?>: </div><div class="value"></div></div>
                        </div>
                    </div>
                    <div class="error-message-section" style="display:none">
