...
?>
<div class="sn-wie-export-page product-category">
    <div class="sn-wie-header">
        <h2><?php echo( __('Export product categories to a CSV file', SN_WIE_SLUG) ); ?></h2>
        <p><?php echo( __('This section allows you to generate and download a CSV file containing a list of all product categories', SN_WIE_SLUG) ); ?></p>
    </div>
    <div class="sn-wie-box-section">
        <?php wc_get_template( 'navigation.php', $args, '', SN_WIE_TEMPLATE_PATH .'/product-category/' );?>
        <div class="export-box">
            <form action="<?php echo(admin_url('admin-ajax.php')) ?>" method="post" class="sn-wie-form  export-form product-category">
                <input type="hidden" id="action" name="action" value="sn_wie_create_product_category_csv_file" />
            ...
            <div class="export-modal" style="display:none;">
                <div class="export-dialog">
                    <div class="progress-bar-section">
                        ...
                        <div class="import-msg"><?php echo( __('Exporting product categories, please do not close or refresh the browser!', SN_WIE_SLUG) ); ?></div>
                    </div>
                    <div class="export-status-section" style="display:none">
                        <div class="status-box">
                            ...
                            <div class="stat export-count"><div class="caption"><?php echo( __('Categories Exported', SN_WIE_SLUG) ); ?>: </div><div class="value">0</div></div>
