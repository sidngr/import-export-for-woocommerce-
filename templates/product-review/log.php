...
?>
<div class="sn-wie-log-page product-review">
    <div class="sn-wie-header">
        <h2><?php echo( __('View product review import export logs', SN_WIE_SLUG) ); ?></h2>
        ...
        <div class="log-box">
            <div class="content">
                <div class="table-actions">
                    ...
                    <a href="<?php echo(admin_url('admin-post.php')) ?>?action=sn_wie_delete_product_review_log" class="button button-primary btn-export right"><?php echo( __('Delete All', SN_WIE_SLUG) ); ?></a>
                </div>
